...
const FENCE_CATEGORIES = [
  {
    id: 'vinyl', name: { EN: 'Vinyl / PVC', ES: 'Vinilo / PVC' }, tag: { EN: 'Privacy, Picket & Ranch', ES: 'Privacidad, picket y rancho' }, img: 'vinyl', href: 'vinyl.html', desc: { EN: "Low-maintenance vinyl in privacy, picket and ranch profiles. Won't rot, rust, peel or fade, engineered for Florida sun and salt air with a transferable lifetime warranty.", ES: 'Vinilo de bajo mantenimiento en perfiles de privacidad, picket y rancho. No se pudre, no se oxida, no se pela ni decolora, diseñado para el sol y aire salino de Florida con garantía de por vida transferible.' }, }, {
    id: 'aluminum', name: { EN: 'Aluminum', ES: 'Aluminio' }, tag: { EN: 'Residential & Commercial', ES: 'Residencial y comercial' }, img: 'aluminum', href: 'aluminum.html', desc: { EN: 'Powder-coated aluminum panels in 2 and 3-rail standard configurations (4-rail custom). Pool-code compliant, rackable on grade and available in residential and commercial grades.', ES: 'Paneles de aluminio con pintura en polvo en configuraciones estándar de 2 y 3 rieles (4 rieles a medida). Cumple código de piscinas, adaptable a pendientes y disponible en grados residencial y comercial.' }, }, {
    id: 'chainlink', name: { EN: 'Chain Link', ES: 'Malla ciclónica' }, tag: { EN: 'Galvanized & Vinyl Coated', ES: 'Galvanizada y recubierta de vinilo' }, img: 'chainlink', href: 'chain-link.html', desc: { EN: 'Galvanized and vinyl-coated mesh from 6 to 12 gauge. The workhorse fence for security, sports, agricultural and commercial perimeters across SW Florida.', ES: 'Malla galvanizada y recubierta de vinilo de calibre 6 a 12. La cerca de trabajo para seguridad, deporte, agricultura y perímetros comerciales en el suroeste de Florida.' }, }, {
    id: 'metal', name: { EN: 'Metal / DuraFence', ES: 'Metal / DuraFence' }, tag: { EN: 'Metal Privacy', ES: 'Privacidad de metal' }, img: 'metal', href: 'metal.html', desc: { EN: 'Metal privacy fencing (DuraFence), the strength of metal with the look of solid board. Standard board is vertical; horizontal also available. Hurricane-rated, no warping, no painting, no replacement boards.', ES: 'Cerca de privacidad de metal (DuraFence), la fuerza del metal con el aspecto de tabla sólida. La tabla estándar es vertical; también hacemos horizontal. Resistente a huracanes, no se deforma, no se pinta, no se reemplazan tablas.' }, }, {
    id: 'ecfence', name: { EN: 'EC Fence', ES: 'EC Fence' }, tag: { EN: 'Self-Mating Galvanized Steel', ES: 'Acero galv. autoensamblable' }, img: 'ecfence', href: 'ecfence.html', isNew: true, desc: { EN: 'Our newest system: self-mating galvanized steel panels installed every 12 ft. 6 ft tall, available in bronze and white. Engineered for Exposure C wind loads.', ES: 'Nuestro sistema más nuevo: paneles de acero galvanizado autoensamblables instalados cada 12 pies. 6 pies de alto, disponibles en bronce y blanco. Diseñados para cargas eólicas Exposición C.' }, },
];

const GATE_SYSTEMS = [
  {
    id: 'single-swing', name: { EN: 'Single Gate', ES: 'Portón sencillo' }, tag: { EN: 'Walk & entry gates', ES: 'Peatonales y de entrada' }, img: 'gate-single', href: 'gate-single.html', desc: { EN: 'Single walk gates for entry points, fabricated in-house and available in vinyl, chain link, metal and aluminum to match your fence. Standard and custom sizes.', ES: 'Portones peatonales para puntos de entrada, fabricados en planta y disponibles en vinilo, malla, metal y aluminio para combinar con tu cerca. Tamaños estándar y a medida.' }, }, {
    id: 'double-swing', name: { EN: 'Double Gate', ES: 'Portón doble' }, tag: { EN: 'Driveway drive gates', ES: 'Portones de acceso vehicular' }, img: 'gate-double', href: 'gate-double.html', desc: { EN: 'Double drive gates for driveway access, fabricated in-house in vinyl, chain link, metal and aluminum, standard or custom sized, with matching hardware.', ES: 'Portones dobles para acceso vehicular, fabricados en planta en vinilo, malla, metal y aluminio, estándar o a medida, con herrajes a juego.' }, }, {
    id: 'sliding', name: { EN: 'Sliding Gate', ES: 'Portón corredizo' }, tag: { EN: 'Space-saving access', ES: 'Acceso que ahorra espacio' }, img: 'gate-sliding', href: 'gate-sliding.html', desc: { EN: 'Sliding gates for openings with no room to swing. Fabricated in-house and available in standard and custom sizes.', ES: 'Portones corredizos para aberturas sin espacio para abatir. Fabricados en planta, en tamaños estándar y a medida.' }, }, {
    id: 'cantilever', name: { EN: 'Cantilever Gate', ES: 'Portón cantilever' }, tag: { EN: 'Commercial & industrial', ES: 'Comercial e industrial' }, img: 'gate-cantilever', href: 'gate-cantilever.html', desc: { EN: 'Cantilever gates built for easy operation and long-lasting use, quick, secure entry to and from your property.', ES: 'Portones cantilever construidos para operación fácil y uso duradero, entrada y salida rápida y segura de tu propiedad.' }, }, {
    id: 'rolling', name: { EN: 'Rolling Gate', ES: 'Portón rodante' }, tag: { EN: 'Industrial rolling gates', ES: 'Portones rodantes industriales' }, img: 'gate-rolling', href: 'gate-rolling.html', desc: { EN: 'Rolling gates built for easy operation and long-lasting use, for quick and secure entry to and from your property.', ES: 'Portones rodantes construidos para operación fácil y uso duradero, para entrada y salida rápida y segura de tu propiedad.' }, },
];

const SectionHeader = ({ kicker, title, sub }) => (
  <div style={{
    borderBottom: '1px solid var(--ink)', paddingBottom: 24, marginBottom: 56, }}>
    {kicker && (
      <div className="mono" style={{
        fontSize: 14, letterSpacing: '0.18em', color: 'var(--charcoal)', textTransform: 'uppercase', marginBottom: 14, }}>{kicker}</div>
    )}
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 32, flexWrap: 'wrap' }}>
      <h2 className="display" style={{
        fontSize: 'clamp(36px, 4.6vw, 60px)', margin: 0, lineHeight: 1, letterSpacing: '-0.015em', maxWidth: 620, }}>{title}</h2>
      {sub && (
        <p style={{
          fontSize: 16.5, color: 'var(--charcoal)', margin: 0, maxWidth: 380, lineHeight: 1.55, }}>{sub}</p>
      )}
    </div>
  </div>
);
...
const ProductSelector = ({ items, ctaLabel = 'Learn More' }) => {
  ...
  return (
    <div style={{
      display: 'grid', gridTemplateColumns: '1.1fr 1.2fr 1fr', gap: 56, alignItems: 'start', }}>
        ...
        {items.map((it, i) => {
          ...
          return (
            <button key={it.id} onClick={() => setActive(i)}
              ...
              {it.isNew && (
                <span style={{
                  background: 'var(--tangerine)', color: 'var(--ink)', fontSize: 13, fontWeight: 700, letterSpacing: '0.18em', padding: '4px 7px', }}>NEW</span>
              )}
            </button>
          );
        })}
      ...
      <div style={{
        ...
        <img loading="lazy" decoding="async"
          ...
          alt={item.name}
          style={{
            position: 'relative', width: '88%', height: '88%', objectFit: 'cover', display: 'block', animation: 'fadeUp 0.4s ease', }}/>
        <style>{`
      ...
      <div style={{ paddingTop: 12 }}>
        <div className="mono" style={{
          fontSize: 14, letterSpacing: '0.18em', color: 'var(--charcoal)', textTransform: 'uppercase', marginBottom: 14, }}>{item.tag}</div>
        <h3 className="display" style={{
          fontSize: 'clamp(24px, 2vw, 32px)', margin: '0 0 18px', lineHeight: 1.1, letterSpacing: '-0.01em', }}>{item.name}</h3>
        <p key={item.id + '-desc'} style={{
          fontSize: 16.5, lineHeight: 1.65, color: 'var(--charcoal)', margin: '0 0 28px', animation: 'fadeUp 0.4s ease', }}>{item.desc}</p>
  ...
  return (
    <a href={item.href || '#'}
      ...
      <div style={{
        ...
        {/* Number badge */}
        <div className="mono" style={{
          position: 'absolute', top: 14, left: 14, fontSize: 13.5, fontWeight: 600, letterSpacing: '0.18em', color: 'var(--ink)', background: 'var(--white)', padding: '5px 9px', }}>{num}</div>
        {item.isNew && (
          <div className="mono" style={{
            position: 'absolute', top: 14, right: 14, fontSize: 13.5, fontWeight: 700, letterSpacing: '0.18em', color: 'var(--ink)', background: 'var(--tangerine)', padding: '5px 9px', }}>NEW</div>
        )}
      </div>

      {/* Content */}
      <div style={{
        padding: featured ? '32px 32px 28px' : '24px 24px 22px', display: 'flex', flexDirection: 'column', gap: 12, flex: 1, }}>
        <div className="mono" style={{
          fontSize: 14, letterSpacing: '0.16em', color: 'var(--charcoal)', textTransform: 'uppercase', }}>{item.tag}</div>

        <h3 className="display" style={{
          margin: 0, fontSize: featured ? 'clamp(28px, 2.6vw, 38px)' : 'clamp(20px, 1.8vw, 24px)', lineHeight: 1.05, letterSpacing: '-0.01em', }}>{item.name}</h3>

        {featured && (
          <p style={{
            fontSize: 15.5, lineHeight: 1.6, color: 'var(--charcoal)', margin: '6px 0 0', maxWidth: 480, }}>{item.desc}</p>
        )}
        ...
        <div style={{
          ...
          <span style={{
            width: 32, height: 32, border: '1px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', background: hover ? 'var(--ink)' : 'transparent', color: hover ? 'var(--white)' : 'var(--ink)', transition: 'all 0.2s ease', }}>
...
const FenceStyleCard = ({ item, index }) => {
  ...
  return (
    <a href={item.href || '#'}
      ...
      <div style={{
        position: 'absolute', inset: 0, background: 'linear-gradient(180deg, rgba(38, 49, 102,0) 35%, rgba(38, 49, 102,0.55) 65%, rgba(38, 49, 102,0.92) 100%)', }}/>

      {/* New badge, top-right */}
      {item.isNew && (
        <span className="mono" style={{
          position: 'absolute', top: 12, right: 12, fontSize: 13, fontWeight: 700, letterSpacing: '0.22em', color: 'var(--ink)', background: 'var(--tangerine)', padding: '5px 8px', }}>{t('NEW', 'NUEVO')}</span>
      )}
      ...
      <div style={{
        ...
        <h3 className="display" style={{
          margin: '0 0 6px', fontSize: 'clamp(17px, 1.5vw, 22px)', lineHeight: 1, letterSpacing: '-0.01em', }}>{nameStr}</h3>
        <div className="mono" style={{
          fontSize: 13.5, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.85)', }}>{tagStr}</div>
      </div>

      {/* Hover arrow, bottom-right */}
      <span style={{
        position: 'absolute', bottom: 16, right: 16, width: 32, height: 32, background: 'var(--tangerine)', color: 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: hover ? 1 : 0, transform: hover ? 'translate(0,0)' : 'translate(6px, 6px)', transition: 'opacity 0.25s ease, transform 0.25s ease', }}>
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
...
const FENCE_RARITY = {
  ...
  ecfence:   { c1: 'var(--tangerine)', c2: '#263166' }, // tangerine accent → ink
};
const GATE_RARITY = {
  ...
  'rolling':      { c1: '#a8c5ff', c2: 'var(--tangerine)' }, // industrial orange
};
  ...
  return (
    ...
    >
      <div className="fence-card__inner">
        ...
        {item.isNew && (
          <span className="mono" style={{
            position: 'absolute', top: 10, [right ? 'left' : 'right']: 10, fontSize: 9.5, fontWeight: 700, letterSpacing: '0.2em', color: 'var(--ink)', background: r.c1, padding: '4px 6px', }}>{t('NEW', 'NUEVO')}</span>
        )}

        {/* name pinned bottom */}
        <div style={{ position: 'absolute', left: 14, right: 14, bottom: 14, textAlign: right ? 'right' : 'left' }}>
          <h3 className="display" style={{
            margin: 0, color: 'var(--white)', fontSize: 'clamp(13px, 0.95vw, 16px)', lineHeight: 1.05, letterSpacing: '-0.01em', }}>{nameStr}</h3>
        </div>
      </div>
    </button>
  );
...
const SystemDetail = ({ item, active, rarity, align, ctaLabel }) => {
  ...
  return (
    <div style={{
      gridArea: '1 / 1', maxWidth: 560, justifySelf: right ? 'end' : 'start', textAlign: right ? 'right' : 'left', opacity: active ? 1 : 0, visibility: active ? 'visible' : 'hidden', transform: active ? 'translateY(0)' : 'translateY(8px)', transition: 'opacity 0.45s ease, transform 0.45s ease', pointerEvents: active ? 'auto' : 'none', }}>
      <h2 className="display" style={{
        margin: '0 0 clamp(8px, 1.4vh, 14px)', color: 'var(--white)', fontSize: 'clamp(32px, 3vw + 1.6vh, 72px)', lineHeight: 0.92, letterSpacing: '-0.02em', fontWeight: 800, textShadow: '0 4px 30px rgba(0,0,0,0.4)', }}>{nameStr}</h2>
      <p style={{
        margin: '0 0 clamp(14px, 2.4vh, 26px)', maxWidth: 480, marginLeft: right ? 'auto' : 0, fontSize: 'clamp(13px, 1.4vh, 15px)', lineHeight: 1.55, color: 'rgba(255,255,255,0.86)', }}>{t(item.desc)}</p>
      <a href={item.href || '#'} className="mono" style={{
        display: 'inline-flex', alignItems: 'center', gap: 12, fontSize: 14.5, fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--ink)', background: 'var(--tangerine)', padding: 'clamp(11px, 1.6vh, 14px) 22px', }}>
        {t(ctaLabel)} {nameStr}
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
...
const SystemArena = ({ sectionId, items, rarity, label, chapter, align, variant, topLink, ctaLabel }) => {
  ...
  return (
    <section id={sectionId} className="fence-arena" style={{
      minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 'clamp(124px, 14vh, 152px) 0 clamp(24px, 4vh, 48px)', }}>
      ...
      <div className="container fence-arena__inner" style={{
        ...
        <div style={{
          display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexDirection: right ? 'row-reverse' : 'row', gap: 24, flexWrap: 'wrap', borderBottom: '1px solid rgba(255,255,255,0.20)', paddingBottom: 'clamp(12px, 1.8vh, 20px)', marginBottom: 'clamp(14px, 2.6vh, 34px)', }}>
          <div style={{
            display: 'flex', alignItems: 'center', gap: 14, flexDirection: right ? 'row-reverse' : 'row', }}>
            <span className="mono" style={{
              fontSize: 14, fontWeight: 700, letterSpacing: '0.18em', color: 'var(--ink)', background: r.c1, padding: '4px 8px', }}>{chapter}</span>
            <span className="display" style={{
              fontSize: 'clamp(18px, 1.4vw + 0.8vh, 30px)', fontWeight: 800, letterSpacing: '0.02em', color: 'var(--white)', lineHeight: 1, }}>{t(label)}</span>
          ...
          <a href={topLink.href} className="mono" style={{
            display: 'inline-flex', alignItems: 'center', gap: 10, fontSize: 14, fontWeight: 700, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--white)', borderBottom: '1px solid rgba(255,255,255,0.6)', paddingBottom: 4, }}>
            {t(topLink.label)}
...
const SlatArena = ({ id, chapter, label, items, topLink, ctaLabel }) => {
  ...
  return (
    ...
    <section id={id} className="wfs-slat-section" style={{
      background: 'var(--indigo-blue)', height: 'clamp(540px, calc(100svh - 118px), 880px)', display: 'flex', flexDirection: 'column', overflow: 'hidden', }}>
      {/* Header */}
      <div className="container" style={{
        width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap', padding: 'clamp(18px, 3vh, 30px) var(--pad)', }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
          <span className="mono" style={{
            background: 'var(--laser-blue)', color: 'var(--white)', padding: '3px 7px', fontSize: 14.5, fontWeight: 700, lineHeight: 1, }}>{chapter}</span>
          <h2 className="display" style={{
            margin: 0, fontSize: 'clamp(28px, 2.6vw, 40px)', fontWeight: 800, letterSpacing: '-0.01em', textTransform: 'capitalize', color: 'var(--white)', lineHeight: 1, }}>{t(label)}</h2>
          <span aria-hidden style={{ width: 90, height: 2, background: 'var(--laser-blue)' }}/>
        </div>
        <a href={topLink.href} className="mono" style={{
          fontSize: 'clamp(12px, 1vw, 15px)', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--white)', }}>{t(topLink.label)} →</a>
      </div>
        ...
        {items.map((c, i) => {
          ...
          return (
            <a key={c.id} href={c.href}
              ...
              {c.isNew && (
                <span className="mono" style={{
                  position: 'absolute', top: 22, right: 22, background: 'var(--tangerine)', color: 'var(--white)', padding: '4px 8px', fontSize: 13.5, fontWeight: 700, letterSpacing: '0.22em', textTransform: 'uppercase', lineHeight: 1, }}>{t('New', 'Nuevo')}</span>
              )}
              {/* Collapsed, vertical label */}
              <span className="mono wfs-slat__vlabel" style={{
                position: 'absolute', bottom: 26, left: 22, fontSize: 'clamp(13px, 1.1vw, 19px)', fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--white)', whiteSpace: 'nowrap', opacity: exp ? 0 : 1, transition: 'opacity 0.3s ease', }}>{t(c.name)}</span>
              {/* Expanded content */}
...
/* Mobile-only: horizontal snap carousel of full product cards with a
   "01 / 05" progress indicator. Replaces the hover-driven slats on phones, where the expanding-slat interaction doesn't work on touch. */
    ...
    <section id={`${id}-mobile`} className="wfs-msys" style={{ background: 'var(--indigo-blue)' }}>
      ...
      <div className="container" style={{ paddingTop: 'clamp(48px, 8vh, 72px)', paddingBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <span className="mono" style={{
            background: 'var(--laser-blue)', color: 'var(--white)', padding: '4px 8px', fontSize: 14.5, fontWeight: 700, lineHeight: 1, }}>{chapter}</span>
          <h2 className="display" style={{
            margin: 0, fontSize: 'clamp(30px, 9vw, 40px)', fontWeight: 800, letterSpacing: '-0.01em', color: 'var(--white)', lineHeight: 1, }}>{t(label)}</h2>
          <span aria-hidden style={{ flex: 1, height: 2, background: 'rgba(151,186,255,0.5)' }}/>
        </div>
        <a href={topLink.href} className="mono" style={{
          display: 'inline-flex', alignItems: 'center', gap: 10, marginTop: 16, fontSize: 14.5, fontWeight: 700, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--tangerine)', }}>
          {t(topLink.label)}
          <svg width="13" height="13" viewBox="0 0 16 16" fill="none">
            <path d="M3 8h10m0 0L9 4m4 4l-4 4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="square"/>
          </svg>
        ...
        {items.map((c, i) => (
          <a key={c.id} href={c.href} className="wfs-msys__card">
            <div className="wfs-msys__imgwrap">
              ...
              {c.isNew && (
                <span className="mono" style={{
                  position: 'absolute', top: 16, right: 16, background: 'var(--tangerine)', color: 'var(--white)', padding: '4px 8px', fontSize: 13.5, fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', lineHeight: 1, }}>{t('New', 'Nuevo')}</span>
              )}
            </div>
            <div style={{ padding: '22px 2px 4px' }}>
              <h3 className="display" style={{
                margin: '0 0 12px', fontSize: 27.5, fontWeight: 800, letterSpacing: '-0.01em', color: 'var(--white)', lineHeight: 1, textTransform: 'capitalize', }}>{t(c.name)}</h3>
              <p style={{
                margin: '0 0 18px', fontSize: 16.5, lineHeight: 1.5, color: 'rgba(219,233,238,0.82)', }}>{t(c.desc)}</p>
              <span className="mono" style={{
                display: 'inline-flex', alignItems: 'center', gap: 10, fontSize: 14.5, fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'var(--tangerine)', }}>{t(ctaLabel)} <span style={{ fontSize: '1.2em' }}>→</span></span>
            </div>
          </a>
        ))}
      </div>
      ...
      <div className="container" style={{
        display: 'flex', alignItems: 'center', gap: 16, paddingTop: 22, paddingBottom: 'clamp(40px, 7vh, 64px)', }}>
        <span className="mono" style={{
          fontSize: 15.5, fontWeight: 700, letterSpacing: '0.14em', color: 'var(--white)', whiteSpace: 'nowrap', }}>{String(active + 1).padStart(2, '0')} / {String(items.length).padStart(2, '0')}</span>
        <span style={{ flex: 1, height: 3, background: 'rgba(255,255,255,0.2)', position: 'relative' }}>
          <span style={{
            position: 'absolute', left: 0, top: 0, bottom: 0, width: `${((active + 1) / items.length) * 100}%`, background: 'var(--tangerine)', transition: 'width 0.3s ease', }}/>
        </span>
      </div>
    </section>
  );
...
const SystemTabs = ({ id, chapter, label, items, topLink, ctaLabel }) => {
  ...
  return (
    ...
    <section id={id} className="wfs-systemtabs" style={{
      background: 'var(--indigo-blue)', display: 'flex', flexDirection: 'column', overflow: 'hidden', }}>
      ...
      <div className="wfs-systemtabs__bar" role="tablist" style={{
        display: 'grid', gridTemplateColumns: `repeat(${items.length}, 1fr)`, borderTop: '1px solid rgba(255,255,255,0.14)', borderBottom: '1px solid rgba(255,255,255,0.14)', }}>
        {items.map((it, i) => {
          const on = i === active;
          return (
            <button key={it.id} role="tab" aria-selected={on}
              ...
              style={{
                display: 'flex', alignItems: 'center', gap: 12, padding: 'clamp(13px, 2vh, 19px) clamp(14px, 1.6vw, 26px)', background: on ? 'rgba(255,255,255,0.05)' : 'transparent', border: 'none', borderRight: i < items.length - 1 ? '1px solid rgba(255,255,255,0.14)' : 'none', borderBottom: on ? '2px solid var(--tangerine)' : '2px solid transparent', cursor: 'pointer', textAlign: 'left', minWidth: 0, transition: 'background 0.2s ease', }}>
              <span className="mono" style={{
                fontSize: 14.5, fontWeight: 700, flexShrink: 0, color: on ? 'var(--tangerine)' : 'rgba(219,233,238,0.5)', }}>0{i + 1}</span>
              <span className="mono" style={{
                fontSize: 'clamp(10.5px, 0.9vw, 13px)', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: on ? 'var(--white)' : 'rgba(219,233,238,0.55)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', }}>{t(it.name)}</span>
              {it.isNew && (
                <span className="mono" style={{
                  marginLeft: 'auto', flexShrink: 0, background: 'var(--tangerine)', color: 'var(--white)', padding: '3px 6px', fontSize: 11.5, fontWeight: 700, letterSpacing: '0.14em', }}>{t('New', 'Nuevo')}</span>
              )}
            </button>
          );
        })}
  ...
  return (
    <section style={{ background: 'var(--white)', padding: 'clamp(64px, 9vh, 100px) 0' }}>
      <div className="container">
        {/* Header */}
        <div style={{
          display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 32, marginBottom: 'clamp(36px, 5vh, 56px)', flexWrap: 'wrap', }}>
          <div style={{ maxWidth: 620 }}>
            ...
            <p style={{ margin: '18px 0 0', fontSize: 16, lineHeight: 1.6, color: 'var(--charcoal)' }}>
              {t(
                'We were the contractors before we were the supplier, so the yard runs on installer logic, not catalog markup.', 'Fuimos los contratistas antes de ser el proveedor, por eso la sucursal funciona con lógica de instalador, no con margen de catálogo.'
              )}
            </p>
          </div>
          ...
          {WHY_WFS.map((v, i) => (
            ...
            onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = ''; e.currentTarget.style.borderColor = 'rgba(38, 49, 102,0.14)'; }}>
              ...
              <p className="mono" style={{
                margin: 0, fontSize: 14.5, lineHeight: 1.55, color: 'var(--charcoal)', }}>{t(v.desc)}</p>
            </div>
          ))}
        </div>
      </div>
...
Object.assign(window, {
  FenceCategories, GateSystems, SystemArena, WhyWFS, FENCE_CATEGORIES, GATE_SYSTEMS, FenceStyleCard,
});
