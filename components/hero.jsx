...
const Nav = () => {
  ...
  return (
    <header style={{
      position: 'sticky', top: 0, zIndex: 50, background: scrolled ? 'rgba(255,255,255,0.92)' : 'transparent', backdropFilter: scrolled ? 'blur(10px)' : 'none', borderBottom: scrolled ? '1px solid rgba(38, 49, 102,0.08)' : '1px solid transparent', transition: 'all 0.2s ease', }}>
...
const Hero = () => {
  ...
  return (
    <section className="wfs-hero" style={{
      ...
      <div style={{
        position: 'absolute', inset: 0, zIndex: 1, background: 'linear-gradient(95deg, rgba(38, 49, 102,0.82) 0%, rgba(38, 49, 102,0.66) 38%, rgba(38, 49, 102,0.38) 68%, rgba(38, 49, 102,0.22) 100%)', }}/>
      {/* Bottom fade for fence-card band */}
      <div style={{
        position: 'absolute', left: 0, right: 0, bottom: 0, height: '50%', zIndex: 1, background: 'linear-gradient(180deg, rgba(38, 49, 102,0) 0%, rgba(38, 49, 102,0.35) 60%, rgba(38, 49, 102,0.7) 100%)', }}/>
