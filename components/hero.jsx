  ...
  return (
    <a className="wfs-chatbanner" href="contact.html" onClick={openLiveChat}>
      ...
      <span className="container wfs-chatbanner__in">
        ...
        <span className="wfs-chatbanner__cta" aria-hidden="true">
    ...
    <section className="wfs-hero" style={{
      ...
      <div style={{
        ...
        <div className="container" style={{ width: '100%' }}>
          ...
          {/* Titular solo, sin kicker ni parrafo: el cliente pidio la portada
              minimalista (menos texto pequeno, menos botones). */}
          <h1 style={{
            margin: '0 0 30px', fontFamily: 'var(--display)', fontWeight: 800, fontSize: 'clamp(34px, 4.2vw, 56px)', lineHeight: 1.02, letterSpacing: '-0.02em', textTransform: 'uppercase', color: 'var(--white)', textShadow: '0 2px 28px rgba(0,0,0,0.28)', }}>
          ...
          {/* Un solo boton, blanco sobre el video: el naranja queda para el
              detalle del pill de cotizacion de la cabecera. Homeowner /
              Contractor siguen en la barra superior y en el menu. */}
          <a href="products.html" style={{
              display: 'inline-flex', alignItems: 'center', gap: 12, padding: '16px 28px', borderRadius: 999, background: 'var(--white)', color: 'var(--ink)', fontFamily: 'var(--sans)', fontSize: 16.5, fontWeight: 600, letterSpacing: '0.01em', boxShadow: '0 8px 24px rgba(0,16,17,0.25)', transition: 'transform 0.18s, box-shadow 0.18s', }}
            onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 12px 32px rgba(0,16,17,0.35)'; }}
            onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(0,16,17,0.25)'; }}>
            {t('Shop Fence Materials', 'Ver materiales de cerca')}
