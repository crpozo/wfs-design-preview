  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError((err && err.message) || t(
        "We couldn't send your claim. Please email claims@westernfencesupply.com or call (239) 465-2482.", 'No pudimos enviar tu reclamo. Escribe a claims@westernfencesupply.com o llama al (239) 465-2482.'
      ));
    } finally {
      busy.current = false;
      setSending(false);
  ...
  const Field = ({ label, name, type = 'text', placeholder, required, children, span = 1 }) => (
    <div style={{ gridColumn: `span ${span}` }}>
      <label htmlFor={name} className="mono" style={{
        ...
        {label} {required && <span style={{ color: 'var(--sky)' }}>*</span>}
      </label>
      {children || (
        <input
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.7fr 1fr', gap: 56, alignItems: 'start' }}>
          ...
          <article style={{
            ...
            <form onSubmit={handleSubmit}
              ...
              {error && (
                <p role="alert" style={{
                  gridColumn: 'span 2', margin: 0, padding: '14px 16px', background: 'rgba(46, 89, 193,0.08)', border: '1px solid rgba(46, 89, 193,0.35)', fontSize: 15.5, lineHeight: 1.5, color: 'var(--ink)', }}>{error}</p>
              )}
            </form>
            )}
          </article>
          ...
          <aside style={{ minWidth: 0, position: 'sticky', top: 100, display: 'grid', gap: 16 }}>
            <div style={{
              ...
              <div className="mono" style={{
                ...
                <span style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--tangerine)', boxShadow: '0 0 0 3px rgba(46, 89, 193,0.25)' }}/>
              ...
              <a href="tel:2394652482" className="display" style={{
                display: 'block', marginBottom: 6, fontSize: 23.5, color: 'var(--white)', lineHeight: 1.1, letterSpacing: '-0.005em', }}>(239) 465-2482</a>
...
const ClaimsCTA = () => {
  ...
  <CTABand
    ...
    secondary={[t('Call the yard', 'Llamar a la sucursal'), 'tel:2394652482']}
  />
  );
};
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <a href="tel:2394652482" style={{
            display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '16px 28px', background: 'transparent', color: 'var(--white)', border: '1.5px solid rgba(255,255,255,0.5)', fontFamily: 'var(--sans)', fontSize: 14.5, fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', }}>(239) 465-2482</a>
        </div>
      </div>
    </div>
  </section>
