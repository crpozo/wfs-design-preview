    ...
    <div className="container">
      ...
      <div style={{
        ...
        <h2 className="display" style={{
          ...
          <span style={{ color: 'var(--sky)' }}>{t('build once.', 'construye una vez.')}</span>
        </h2>
        <p style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <h2 className="display" style={{
            ...
            <span style={{ color: 'var(--sky)' }}>{t('that fits your home.', 'que va con tu hogar.')}</span>
          </h2>
        </div>
        <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
          ...
          <div className="wfs-faq-sidebar" style={{ position: 'sticky', top: 100 }}>
            <h2 className="display" style={{
              ...
              <span style={{ color: 'var(--sky)' }}>{t('questions.', 'propietarios.')}</span>
            </h2>
            <p style={{
                ...
                <div key={i} style={{
                  ...
                  <button onClick={() => setOpen(isOpen ? -1 : i)} style={{
                    ...
                    <span className="wfs-faq-toggle" style={{
                      width: 28, height: 28, background: isOpen ? 'var(--tangerine)' : 'transparent', border: `1px solid ${isOpen ? 'var(--tangerine)' : 'rgba(38, 49, 102,0.2)'}`, color: isOpen ? 'var(--white)' : 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, transition: 'all 0.2s ease', }}>
    ...
    <div className="container" style={{
      ...
      <div>
        <h2 className="display" style={{
          ...
          <span style={{ color: 'var(--sky)' }}>{t('Quote in 24 hours.', 'Cotización en 24 horas.')}</span>
        </h2>
        <p className="mono" style={{
      ...
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto clamp(40px, 6vh, 60px)' }}>
          ...
          <h2 className="display" style={{ margin: 0, fontSize: 'clamp(28px, 3vw, 42px)', lineHeight: 1.05, letterSpacing: '-0.02em', fontWeight: 800, textTransform: 'uppercase' }}>
            ...
            <span style={{ color: 'var(--sky)' }}>{t('today?', 'hoy?')}</span>
          </h2>
    ...
    <div className="container" style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: 700 }}>
        ...
        <h1 style={{
          ...
          <span style={{ color: 'var(--sky)' }}>{t('manufacturer.', 'fabricante.')}</span>
        </h1>
        <p style={{
    ...
    <div className="container">
      ...
      <div style={{
        ...
        <h2 className="display" style={{
          ...
          <span style={{ color: 'var(--sky)' }}>{t('with WFS.', 'con WFS.')}</span>
        </h2>
        <p style={{
    ...
    <div className="container" style={{
      ...
      <div>
        <h2 className="display" style={{
          ...
          <span style={{ color: 'var(--sky)' }}>{t('Quote forever.', 'Cotiza siempre.')}</span>
        </h2>
        <p className="mono" style={{
