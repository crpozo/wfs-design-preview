      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: 64, alignItems: 'start' }}>
        ...
        <div style={{ position: 'relative', paddingLeft: 56 }}>
          ...
          {[
            ...
            ['02', { EN: 'In-house fabrication', ES: 'Fabricación en planta' }, { EN: 'Gates and custom work are fabricated in-house at our Fort Myers yard.', ES: 'Los portones y los trabajos a medida se fabrican en planta, en nuestra sucursal de Fort Myers.' }],
            ['03', { EN: 'Four fence systems', ES: 'Cuatro sistemas de cercas' },   { EN: 'Premium vinyl, aluminum, chain link and metal fencing, sold to fence companies and homeowners alike.', ES: 'Cercas premium de vinilo, aluminio, malla ciclónica y metal, para empresas de cercas y propietarios por igual.' }],
            ...
            ['05', { EN: 'Delivery or pickup', ES: 'Entrega o retiro' },   { EN: 'Job-site delivery on our own trucks, or same-day pickup on standard qualifying orders.', ES: 'Entrega en obra con nuestros propios camiones, o retiro el mismo día en pedidos estándar que califiquen.' }],
          ].map(([y, label, body], i, arr) => (
            <div key={y} style={{
              position: 'relative',
