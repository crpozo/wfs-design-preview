...
const AboutStory = () => {
  ...
  <section style={{ background: 'var(--white)', padding: '120px 0' }}>
    <div className="container">
      ...
      <div style={{
        display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 56, alignItems: 'end', paddingBottom: 32, marginBottom: 64, borderBottom: '1px solid rgba(38, 49, 102,0.12)', }}>
        <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: 64, alignItems: 'start' }}>
        ...
        <div style={{ position: 'sticky', top: 120 }}>
          <div style={{
            ...
            <img src="assets/hero-warehouse.webp" alt={t('WFS Fort Myers warehouse', 'Almacén de WFS en Fort Myers')}
        ...
        <div style={{ position: 'relative', paddingLeft: 56 }}>
          {/* Spine line */}
          <div aria-hidden style={{
            position: 'absolute', left: 17, top: 14, bottom: 14, width: 1, background: 'rgba(168, 197, 255,0.5)', }}/>
          {[
            ...
            <div key={y} style={{
              ...
              <span aria-hidden style={{
                position: 'absolute', left: -45, top: 10, width: 14, height: 14, borderRadius: '50%', background: 'var(--sky)', border: '3px solid var(--white)', boxShadow: '0 0 0 1px rgba(168, 197, 255,0.6)', }}/>
              <div style={{
  ...
  return (
    <section style={{ background: 'var(--white)', padding: '120px 0' }}>
      <div className="container">
        ...
        <div style={{
          display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 32, flexWrap: 'wrap', paddingBottom: 28, marginBottom: 56, borderBottom: '1px solid rgba(38, 49, 102,0.12)', }}>
          <div style={{
        ...
        <div style={{
          ...
          {stats.map(([n, label, sub], i) => (
            <div key={label.EN} style={{
              padding: i === 0 ? '0 28px 0 0' : `0 28px`, borderLeft: i === 0 ? 'none' : '1px solid rgba(38, 49, 102,0.12)', }}>
              <div className="display" style={{
