      ...
      <div className="container">
        ...
        <div style={{
          ...
          <a href={TRAINING_LOGIN_URL} target="_blank" rel="noopener" className="mono" style={{
            fontSize: 13.5, fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--tangerine)', borderBottom: '1px solid rgba(46, 89, 193,0.5)', paddingBottom: 3, whiteSpace: 'nowrap', }}>
            ...
            <div>
              ...
              <div style={{ marginTop: 22, display: 'flex', alignItems: 'center', gap: 18, flexWrap: 'wrap' }}>
                <a href={TRAINING_LOGIN_URL} target="_blank" rel="noopener"
                  ...
                  style={{
                    display: 'inline-flex', alignItems: 'center', gap: 12, padding: '15px 26px', background: 'var(--tangerine)', color: 'var(--white)', fontFamily: 'var(--sans)', fontSize: 14.5, fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', boxShadow: '0 10px 26px rgba(46, 89, 193,0.35)', transition: 'transform 0.18s', }}
