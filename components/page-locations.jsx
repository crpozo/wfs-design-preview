          ...
          <article key={y.key} id={y.anchor} style={{
            ...
            <div style={{ position: 'relative', aspectRatio: '16 / 9', background: '#263166' }}>
              ...
              <span className="mono" style={{
                position: 'absolute', top: 14, left: 14, background: 'var(--laser-blue)', color: 'var(--white)', padding: '5px 10px', fontSize: 13.5, letterSpacing: '0.18em', fontWeight: 700, }}>{t(y.chip)}</span>
            </div>
    ...
    <div className="container">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
        {steps.map(([title, body], i) => (
          <div key={i} className="wfs-sharp" style={{
