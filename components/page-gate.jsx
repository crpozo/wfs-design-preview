...
const GATE_DATA = {
  single: {
    slug: 'single', name: 'Single Swing', tag: 'Single swing gate materials & hardware', heroTitle: 'Single Swing Gates Built', heroAccent: 'for the Right Opening.', heroBody: 'Single swing gates for pedestrian access, pool enclosures, side yards, and residential or commercial openings. Available in multiple materials, sizes, colors, and hardware options. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/SINGLE_SWING_GATE.png', quickFacts: [
      ...
      { name: 'Standard Walk Gate', tag: 'Pedestrian', notes: 'Common single gate sizes for pedestrian access.', img: 'assets/projects/gate-single-walk.png' }, { name: 'Custom Opening Gate', tag: 'Made to size', notes: 'Built to match your exact opening size.', img: 'assets/projects/gate-single-custom-pvc.png' }, { name: 'Matching Material Gate', tag: 'All materials', notes: 'Available in aluminum, vinyl, chain link, metal, and EC Fence styles.', img: 'assets/projects/gate-single-matching-ecfence.png' }, ], specs: GATE_SPECS, applications: [
    ...
    slug: 'double', name: 'Double Swing', tag: 'Double swing gate materials & hardware', heroTitle: 'Double Swing Gates Built', heroAccent: 'for Wider Openings.', heroBody: 'Double swing gates for driveways, equipment access, and wider residential or commercial openings. Available in multiple materials, sizes, colors, and hardware options. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/DOUBLE_GATE.png', quickFacts: [
      ...
      { name: 'Standard Driveway Gate', tag: 'Vehicle access', notes: 'Common double gate sizes for driveway and vehicle access.', img: 'assets/DOUBLE_GATE.png' }, { name: 'Privacy Drive Gate', tag: 'Solid panels', notes: 'Full privacy panels matched to vinyl or metal runs.', img: 'assets/projects/pvc-privacy-cantilever-gate-white.jpg' }, { name: 'Custom Opening Gate', tag: 'Made to size', notes: 'Built to match your exact driveway opening.', img: 'assets/projects/pvc-gate-sand.jpg' }, { name: 'Matching Material Gate', tag: 'All materials', notes: 'Available in aluminum, vinyl, chain link, metal, and EC Fence styles.', img: 'assets/projects/cl-swing-gate-galv-4.jpg' }, ], specs: GATE_SPECS, applications: [
    ...
    slug: 'sliding', name: 'Sliding Gates', tag: 'Sliding gate materials & hardware', heroTitle: 'Sliding Gates Built', heroAccent: 'for Tight Openings.', heroBody: 'Track-mounted sliding gates for tight or sloped driveways where a swing gate won’t fit. Available in multiple materials, sizes, colors, and hardware options. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/SLIDING_GATE.png', quickFacts: [
      ...
      { name: 'Track-Mounted Slide', tag: 'Space-saving', notes: 'Slides parallel to the fence on a ground track.', img: 'assets/SLIDING_GATE.png' }, { name: 'Privacy Slide Gate', tag: 'Solid panels', notes: 'Full privacy panels for vinyl or metal runs.', img: 'assets/projects/pvc-privacy-cantilever-gate-white.jpg' }, { name: 'Custom Opening Gate', tag: 'Made to size', notes: 'Built to match your exact opening and layout.', img: 'assets/projects/pvc-gate-sand.jpg' }, { name: 'Matching Material Gate', tag: 'All materials', notes: 'Available in chain link, vinyl, metal, and EC Fence styles.', img: 'assets/projects/cl-gate-black.jpg' }, ], specs: GATE_SPECS, applications: [
      ...
      { name: 'Cape Coral Residential', loc: 'Cape Coral, FL', size: '12 ft Opening', material: 'Sliding Gate', type: 'Track-mounted slide gate, manual operation', contractor: 'Coastline Fence Co.', year: '2024', imgUrl: 'assets/SLIDING_GATE.png' }, { name: 'Tight Driveway', loc: 'Fort Myers, FL', size: '14 ft', material: 'Chain Link Gate', type: 'Galvanized slide gate, twin rollers', contractor: 'Industrial Fence FL', year: '2024', imgUrl: 'assets/SLIDING_GATE.png' }, { name: 'Sloped Lot Slide', loc: 'Naples, FL', size: '12 ft', material: 'Vinyl-Coated Gate', type: 'Vinyl-coated slide gate, ground track', contractor: 'Naples Outdoor', year: '2025', imgUrl: 'assets/SLIDING_GATE.png' }, { name: 'Privacy Slide', loc: 'Estero, FL', size: '6 ft', material: 'Metal / DuraFence Gate', type: 'Metal privacy slide gate, matching run', contractor: 'Gulf Perimeter LLC', year: '2025', imgUrl: 'assets/DOUBLE_GATE.png' }, { name: 'Commercial Slide', loc: 'Punta Gorda, FL', size: '16 ft', material: 'EC Fence Gate', type: 'EC Fence slide gate, commercial spec', contractor: 'Harbor Iron Works', year: '2024', imgUrl: 'assets/CANTILEVER.png' }, ], cta: {
      kicker: 'Sliding gate quote', title: 'Ready to Quote Your', accent: 'Gate?', body: 'Send us your opening size, gate height, material, color, swing type, hardware needs, and project location. Photos or drawings help us quote the gate more accurately.', primary: ['Request a Gate Quote', 'estimate.html#contact'], secondary: ['Call +1 239-689-5496', 'tel:2396895496'], }, }, cantilever: {
    slug: 'cantilever', name: 'Cantilever', tag: 'Cantilever gate materials & hardware', heroTitle: 'Cantilever Gates Built', heroAccent: 'for Any Surface.', heroBody: 'Cantilever gates are suspended in the air on internal rollers, the frame never touches the ground, which is their biggest strength. Designed to work over any surface, with openings up to 30 feet wide including the counterweight section. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/CANTILEVER.png', quickFacts: [
      ...
      { name: 'Suspended Frame', tag: 'No ground contact', notes: 'The gate hangs from internal rollers and floats over the opening, nothing touches the ground.', img: 'assets/CANTILEVER.png' }, { name: 'Works Over Any Surface', tag: 'All driveways', notes: 'Concrete, gravel, pavers, grass or uneven ground, the surface below does not matter.', img: 'assets/projects/cl-swing-gate-galv-4.jpg' }, { name: "Max Width 30'", tag: 'With counterweight', notes: 'Openings up to 30 feet wide, counting the counterbalance section.', img: 'assets/projects/pvc-privacy-cantilever-gate-white.jpg' }, { name: 'Material Options', tag: 'All materials', notes: 'Available in chain link, vinyl-coated, metal, and EC Fence styles.', img: 'assets/projects/cl-fence-black.jpg' }, ], hardware: [
      { name: 'Cantilever Rollers', tag: 'Load-bearing', notes: 'Internal roller trucks carry the gate, the frame rides on them, suspended in the air.', img: 'assets/CANTILEVER.png' }, { name: 'Latches & Receivers', tag: 'Closure', notes: 'Cantilever latch and receiver post catch the nose of the gate when closed.', img: 'assets/projects/cl-swing-gate-galv-4.jpg' }, { name: 'Counterbalance Section', tag: 'Structure', notes: 'The tail section counterweights the gate across the opening.', img: 'assets/projects/pvc-privacy-cantilever-gate-white.jpg' }, { name: 'Guide & Support Posts', tag: 'Framework', notes: 'Heavy posts carry the rollers, a cantilever gate uses no hinges.', img: 'assets/projects/cl-fence-black.jpg' }, ], specs: [
      ...
      { name: 'Industrial Yard', loc: 'Fort Myers, FL', size: '30 ft Opening', material: 'Cantilever Gate', type: 'Galvanized cantilever gate, V-rollers', contractor: 'Industrial Fence FL', year: '2024', imgUrl: 'assets/CANTILEVER.png' }, { name: 'Coastal Perimeter', loc: 'Sanibel, FL', size: '24 ft', material: 'Chain Link Gate', type: 'Vinyl-coated cantilever, salt-rated rollers', contractor: 'Harbor Iron Works', year: '2024', imgUrl: 'assets/CANTILEVER.png' }, { name: 'Storage Facility', loc: 'Bonita Springs, FL', size: '26 ft', material: 'Vinyl / PVC Gate', type: 'PVC privacy cantilever gate, white', contractor: 'Industrial Fence FL', year: '2025', imgUrl: 'assets/projects/pvc-privacy-cantilever-gate-white.jpg' }, { name: 'Commercial Entrance', loc: 'Estero, FL', size: '20 ft', material: 'Metal Gate', type: 'DuraFence cantilever gate, privacy face', contractor: 'Gulf Perimeter LLC', year: '2025', imgUrl: 'assets/ROLLING_GATE.png' }, { name: 'Distribution Yard', loc: 'Immokalee, FL', size: '30 ft', material: 'EC Fence Gate', type: 'Custom cantilever, 30 ft with counterweight', contractor: 'Harbor Iron Works', year: '2024', imgUrl: 'assets/SLIDING_GATE.png' }, ], cta: {
      kicker: 'Cantilever gate quote', title: 'Ready to Quote Your', accent: 'Gate?', body: 'Send us your opening size, gate height, material, color, swing type, hardware needs, and project location. Photos or drawings help us quote the gate more accurately.', primary: ['Request a Gate Quote', 'estimate.html#contact'], secondary: ['Call +1 239-689-5496', 'tel:2396895496'], }, }, rolling: {
    slug: 'rolling', name: 'Rolling Gate', tag: 'Rolling gate materials & hardware', heroTitle: 'Rolling Gates Built', heroAccent: 'on Big Wheels.', heroBody: 'What defines a rolling gate is its big rubber wheels, they carry the gate across the opening and are designed for a variety of surfaces, including grass and uneven ground. Guide rollers mount on the posts. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/ROLLING_GATE.png', quickFacts: [
      ...
      { name: 'Big Rubber Wheels', tag: 'Signature feature', notes: 'Large wheels carry the gate across the opening, made to roll over grass and uneven surfaces.', img: 'assets/ROLLING_GATE.png' }, { name: 'Post-Mounted Rollers', tag: 'Guides', notes: 'Guide rollers mount on the posts, not the ground, keeping the gate aligned as it rolls.', img: 'assets/projects/cl-gate-black.jpg' }, { name: 'Posts for Automated Gates', tag: 'Prep only', notes: 'We install the posts and framework for powered gates, we do not build the mechanical operators themselves.', img: 'assets/SLIDING_GATE.png' }, { name: 'Material & Frame', tag: 'Chain link first', notes: 'Chain link is the recommended build; other materials require a double frame.', img: 'assets/projects/cl-swing-gate-galv-4.jpg' }, ], hardware: [
      { name: 'Rolling Gate Kit', tag: 'Core kit', notes: 'Complete rolling gate kit with the big wheels that define this gate type.', img: 'assets/ROLLING_GATE.png' }, { name: "Lock N' Latch", tag: 'Rolling gate latch · PS', notes: "LOCK N' LATCH rolling gate latch (PS), the closure made for rolling gates.", img: 'assets/projects/cl-gate-black.jpg' }, { name: 'Guide Rollers', tag: 'Post-mounted', notes: 'Rollers mount on the posts to keep the gate tracking straight as it rolls.', img: 'assets/SLIDING_GATE.png' }, { name: 'Posts & Framework', tag: 'Structure', notes: 'Gate posts and framework, no hinges and no drop rods on a rolling gate.', img: 'assets/projects/cl-swing-gate-galv-4.jpg' }, ], specs: [
