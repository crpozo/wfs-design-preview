...
const GATE_DATA = {
  ...
  rolling: {
    ...
    gateTypes: [
      { name: 'Big Rubber Wheels', tag: 'Signature feature', notes: 'Large wheels carry the gate across the opening — made to roll over grass and uneven surfaces.', img: 'assets/ROLLING_GATE.png' },
      { name: 'Post-Mounted Rollers', tag: 'Guides', notes: 'Guide rollers mount on the posts, not the ground, keeping the gate aligned as it rolls.', img: 'assets/projects/cl-gate-black.jpg' },
      { name: 'Posts for Automated Gates', tag: 'Prep only', notes: 'We install the posts and framework for powered gates — we do not build the mechanical operators themselves.', img: 'assets/SLIDING_GATE.png' },
    ...
    projects: [
      { name: 'Self-Storage Facility', loc: 'Bonita Springs, FL', size: "Up to 30' total", material: 'Rolling Gate', type: 'Galvanized rolling gate, ground rollers', contractor: 'Industrial Fence FL', year: '2024', imgUrl: 'assets/ROLLING_GATE.png' },
      { name: 'Industrial Yard', loc: 'Fort Myers, FL', size: "Up to 30' total", material: 'Chain Link Gate', type: 'Heavy chain link rolling gate', contractor: 'Industrial Fence FL', year: '2024', imgUrl: 'assets/ROLLING_GATE.png' },
      { name: 'Commercial Perimeter', loc: 'Lehigh Acres, FL', size: "Up to 30' total", material: 'Vinyl-Coated Gate', type: 'Vinyl-coated rolling gate, double frame', contractor: 'Gulf Perimeter LLC', year: '2025', imgUrl: 'assets/ROLLING_GATE.png' },
      { name: 'Transit Hub', loc: 'North Fort Myers, FL', size: "Up to 30' total", material: 'Metal Gate', type: 'Metal rolling gate, double frame', contractor: 'Industrial Fence FL', year: '2025', imgUrl: 'assets/CANTILEVER.png' },
      { name: 'Warehouse Entrance', loc: 'Immokalee, FL', size: "Up to 30' total", material: 'EC Fence Gate', type: 'EC Fence rolling gate, double frame', contractor: 'Harbor Iron Works', year: '2024', imgUrl: 'assets/SLIDING_GATE.png' },
    ],
    cta: {
