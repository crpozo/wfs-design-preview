...
const GATE_DATA = {
  single: {
    slug: 'single',
      opciones: ['Standard Walk Gate', 'Custom Opening Gate'], name: 'Single Swing', tag: 'Single swing gate materials & hardware', heroTitle: 'Single Swing Gates Built', heroAccent: 'for the Right Opening.', heroBody: 'Single swing gates for pedestrian access, pool enclosures, side yards, and residential or commercial openings. Available in multiple materials, sizes, colors, and hardware options. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/SINGLE_SWING_GATE.webp', quickFacts: [
    ...
    slug: 'double',
      opciones: ['Standard Driveway Gate', 'Privacy Drive Gate', 'Custom Opening Gate'], name: 'Double Swing', tag: 'Double swing gate materials & hardware', heroTitle: 'Double Swing Gates Built', heroAccent: 'for Wider Openings.', heroBody: 'Double swing gates for driveways, equipment access, and wider residential or commercial openings. Available in multiple materials, sizes, colors, and hardware options. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/DOUBLE_GATE.webp', quickFacts: [
    ...
    slug: 'sliding',
      opciones: ['Track-Mounted Slide', 'Privacy Slide Gate', 'Custom Opening Gate'], name: 'Sliding Gates', tag: 'Sliding gate materials & hardware', heroTitle: 'Sliding Gates Built', heroAccent: 'for Tight Openings.', heroBody: 'Track-mounted sliding gates for tight or sloped driveways where a swing gate won’t fit. Available in multiple materials, sizes, colors, and hardware options. Send us your opening size and project details for an accurate quote.', heroImg: 'assets/SLIDING_GATE.webp', quickFacts: [
  ...
  React.useEffect(() => {
    if (window.WFSBuilder) {
      ...
      Object.keys(GATE_DATA).forEach(function (k) {
        var d = GATE_DATA[k];
        porTipo[k] = {
          opciones: (d.opciones || []).map(function (n) {
            return (d.gateTypes || []).filter(function (c) { return c.name === n; })[0];
          }).filter(Boolean)
        };
      });
