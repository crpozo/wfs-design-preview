...
const GATE_DATA = {
  single: {
    ...
    heroBody: 'Standard pedestrian and entry gates from 3 to 6 ft wide. Welded or factory-assembled to match every fence material we stock, with latches, hinges and fasteners included (padlock hasp available on request).',
    heroImg: 'assets/SINGLE_SWING_GATE.png',
    bestFor: 'Walk gates, residential side-yards, pool enclosures',
    profiles: [
      { name: 'Standard Walk',       tag: 'Residential',    notes: '3-4 ft wide welded frame, gravity latch and hinge/latch hardware included.' },
      { name: 'Estate Pedestrian',   tag: 'Ornamental',     notes: '4-6 ft welded heavy frame with decorative top option.' },
      { name: 'Pool-Code Gate',      tag: 'Code Compliant', notes: 'Self-closing with magnetic latch, 4 ft, 2-rail, 3" picket spacing.' },
    ...
    specs: [
      ...
      ['Material',   'Chain link, aluminum, vinyl, metal, EC Fence, to match run'],
      ['Hardware',   'Latches, hinges and fasteners included (padlock hasp on request)'],
  ...
  double: {
    ...
    heroAccent: 'Driveway openings, ready to assemble.',
    heroBody: 'Symmetrical driveway-width gates from 8 to 16 ft total opening. Ready-to-assemble with drop rod, gate latch and stainless hardware kit packed per opening, ready to assemble for most layouts.',
  ...
  sliding: {
    ...
    profiles: [
      ...
      { name: 'Custom Slide',        tag: 'Made to order', notes: 'Non-stock widths and finishes fabricated to spec.' },
    ],
    specs: [
  ...
  rolling: {
    slug: 'rolling',
    name: 'Rolling Gate',
    tag: 'Industrial · High-cycle',
    heroTitle: 'Rolling gates.',
    heroAccent: 'Industrial ground rollers.',
    heroBody: 'Industrial rolling gates on ground rollers, built for high-cycle commercial use, secured perimeters and yards. Heavy galvanized frame with stainless-steel hardware, rated for hundreds of cycles a day.',
    heroImg: 'assets/ROLLING_GATE.png',
    bestFor: 'Commercial perimeters, industrial yards, self-storage',
    profiles: [
      { name: 'Standard',            tag: 'Industrial',  notes: 'Heavy galvanized frame with ground rollers and stainless hardware.' },
    ...
    specs: [
      ...
      ['Rollers',     'Ground rollers + end stops + follower rollers + tensioner'],
    ...
    contractor: {
      ...
      heroBody: 'Heavy industrial rolling gates welded to spec, continuous-duty bearings, ground rollers and stainless hardware. Phased delivery, RFQ process, dedicated commercial rep.',
