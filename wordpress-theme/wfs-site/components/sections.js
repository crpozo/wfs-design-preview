...
const FinalCTA = () => {
  ...
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 9, height: 9, borderRadius: "50%", background: "var(--tangerine)", flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { className: "display", style: { fontSize: 21, color: "var(--ink)", lineHeight: 1 } }, y.name), /* @__PURE__ */ React.createElement("span", { style: { ...labelStyle, margin: 0, fontSize: 11.5, color: "var(--charcoal)" } }, y.chip)), /* @__PURE__ */ React.createElement("a", { href: y.tel, className: "display", style: { fontSize: 27, color: "var(--ink)", textDecoration: "none", display: "block", lineHeight: 1.15 } }, y.phone), /* @__PURE__ */ React.createElement("a", { href: `mailto:${y.email}`, style: { fontSize: 16.5, color: "var(--ink)", display: "block", marginTop: 4, borderBottom: "1px solid var(--tangerine)", width: "fit-content" } }, y.email), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "var(--charcoal)", lineHeight: 1.5, marginTop: 12 } }, y.addr[0], /* @__PURE__ */ React.createElement("br", null), y.addr[1]))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: "var(--charcoal)", marginBottom: 32 } }, t("Both yards \xB7 Mon-Fri 7am-4pm \xB7 Sat 7am-12pm", "Ambas sucursales \xB7 Lun-Vie 7am-4pm \xB7 S\xE1b 7am-12pm")), /* @__PURE__ */ React.createElement("div", { style: { paddingTop: 24, borderTop: "1px solid rgba(0,16,17,0.15)" } }, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 14, letterSpacing: "0.16em", color: "var(--ink)", textTransform: "uppercase", display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 8, height: 8, background: "#ff7133", borderRadius: "50%" } }), t("Get a detailed quote", "Pide tu cotizaci\xF3n")))), /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit, style: {
    background: "var(--ink)",
