...
const FEATURED = [
  { sku: 'CL-115G-72', name: { EN: '11-1/2 Gauge Galvanized Mesh', ES: 'Malla galvanizada 11-1/2 Ga.' }, cat: { EN: 'Chain Link', ES: 'Malla ciclónica' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/cl-swing-gate-galv-4.jpg' },
  { sku: 'AL-WLD-S', name: { EN: 'Aluminum Fence Section', ES: 'Sección de cerca de aluminio' }, cat: { EN: 'Aluminum', ES: 'Aluminio' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/alum-2-rail-smooth-bottom-white.jpg' },
  ...
  { sku: 'GT-DBL-12', name: { EN: '12 ft Double Gate', ES: 'Portón doble de 12 ft' }, cat: { EN: 'Gates', ES: 'Portones' }, height: '12 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/pvc-gate-sand.jpg' },
  { sku: 'CL-VC-BK', name: { EN: 'Vinyl-Coated Black Mesh', ES: 'Malla negra revestida de vinilo' }, cat: { EN: 'Chain Link', ES: 'Malla ciclónica' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/cl-fence-black.jpg' },
];
...
const MARQUEE_PRODUCTS = [
  ...
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/gothic-post-cap.jpg',       name: { EN: 'Gothic Post Cap', ES: 'Tapa de poste gótica' },      spec: { EN: 'White · PVC', ES: 'Blanca · PVC' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/chain-link-fabric.jpg',     name: { EN: 'Chain Link Fabric', ES: 'Malla ciclónica' },         spec: { EN: '11-1/2 Ga. · Galvanized', ES: '11-1/2 Ga. · Galvanizada' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/self-closing-hinge.jpg',    name: { EN: 'Self-Closing Hinge', ES: 'Bisagra con resorte' },    spec: { EN: 'Black · Spring-loaded', ES: 'Negra · Autocierre' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/pvc-double-gate.jpg',       name: { EN: 'PVC Double Gate', ES: 'Portón doble de PVC' },       spec: { EN: 'White · Privacy', ES: 'Blanco · Privacidad' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/barbed-wire.jpg',           name: { EN: 'Barbed Wire', ES: 'Alambre de púas' },               spec: { EN: 'Galvanized', ES: 'Galvanizado' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-2-rail.jpg',       name: { EN: 'Aluminum 2-Rail', ES: 'Aluminio 2 rieles' },         spec: { EN: 'Black · Smooth bottom', ES: 'Negro · Base lisa' } },
  ...
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/metal-privacy-white.jpg',   name: { EN: 'Metal Privacy Panel', ES: 'Panel metálico privacidad' }, spec: { EN: 'White · Vertical', ES: 'Blanco · Vertical' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/drop-rod.jpg',              name: { EN: 'Drop Rod', ES: 'Pasador vertical' },                 spec: { EN: 'Black · Powder-coated', ES: 'Negro · Pintura en polvo' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/pvc-semi-privacy.jpg',      name: { EN: 'Semi-Privacy PVC', ES: 'PVC semiprivacidad' },       spec: { EN: 'Tan · Horizontal', ES: 'Arena · Horizontal' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/gate-post-hinge.jpg',       name: { EN: 'Gate Post Hinge', ES: 'Bisagra de poste' },          spec: { EN: 'Black · Heavy duty', ES: 'Negra · Uso rudo' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-3-rail.jpg',       name: { EN: 'Aluminum 3-Rail', ES: 'Aluminio 3 rieles' },         spec: { EN: 'Black · Rake bottom', ES: 'Negro · Base inclinada' } },
  ...
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/chain-link-gate.jpg',       name: { EN: 'Chain Link Gate', ES: 'Portón de malla' },           spec: { EN: 'Black · Single swing', ES: 'Negro · Una hoja' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/post-mount-latch.jpg',      name: { EN: 'Post-Mount Latch', ES: 'Pestillo de poste' },        spec: { EN: 'Black · Self-locking', ES: 'Negro · Autobloqueante' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/metal-horizontal-black.jpg', name: { EN: 'Horizontal Metal Panel', ES: 'Panel metálico horizontal' }, spec: { EN: 'Black · Louvered', ES: 'Negro · Persiana' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/pvc-picket-panel.jpg',      name: { EN: 'PVC Picket Panel', ES: 'Panel de estacas PVC' },     spec: { EN: 'White · Spaced picket', ES: 'Blanco · Estaca espaciada' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/metal-post.jpg',            name: { EN: 'Metal Post', ES: 'Poste metálico' },                 spec: { EN: 'Black · Square', ES: 'Negro · Cuadrado' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/privacy-windscreen.jpg',    name: { EN: 'Privacy Windscreen', ES: 'Malla sombra' },           spec: { EN: 'Black · Grommeted', ES: 'Negra · Con ojales' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-puppy-picket.jpg', name: { EN: 'Puppy Picket Section', ES: 'Sección puppy picket' }, spec: { EN: 'Black · Aluminum', ES: 'Negra · Aluminio' } },
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-section.jpg',      name: { EN: 'Aluminum Section', ES: 'Sección de aluminio' },      spec: { EN: 'Black · Flat top', ES: 'Negra · Remate plano' } },
];
...
const ProjectGallery = ({ featuredMaterial, items }) => {
  ...
  const projects = curated ? items : [
    ...
    { name: { EN: 'Lehigh Acres Warehouse', ES: 'Bodega Lehigh Acres' }, loc: 'Lehigh Acres, FL', size: '0.6 mi', material: 'Chain Link', type: { EN: 'Chainlink fence, black', ES: 'Cerca de malla ciclónica, negra' }, contractor: 'Industrial Fence FL', year: '2025', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/cl-gate-black.jpg' },
