...
const FEATURED = [
  { sku: 'CL-115G-72', name: { EN: '11-1/2 Gauge Galvanized Mesh', ES: 'Malla galvanizada 11-1/2 Ga.' }, cat: { EN: 'Chain Link', ES: 'Malla ciclónica' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/cl-swing-gate-galv-4.jpg' }, { sku: 'AL-WLD-S', name: { EN: 'Aluminum Fence Section', ES: 'Sección de cerca de aluminio' }, cat: { EN: 'Aluminum', ES: 'Aluminio' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/alum-2-rail-smooth-bottom-white.jpg' }, { sku: 'PV-PRV-W', name: { EN: 'Catalyst Privacy Vinyl, White', ES: 'Vinilo de privacidad Catalyst, blanco' }, cat: { EN: 'Vinyl', ES: 'Vinilo' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/pvc-privacy-gate-white.jpg' }, { sku: 'MT-PRV-72', name: { EN: 'Metal Board Privacy', ES: 'Privacidad de tablero de metal' }, cat: { EN: 'Metal', ES: 'Metal' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/met-fence-horizontal-black.jpg' }, { sku: 'GT-DBL-12', name: { EN: '12 ft Double Gate', ES: 'Portón doble de 12 ft' }, cat: { EN: 'Gates', ES: 'Portones' }, height: '12 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/pvc-gate-sand.jpg' }, { sku: 'CL-VC-BK', name: { EN: 'Vinyl-Coated Black Mesh', ES: 'Malla negra revestida de vinilo' }, cat: { EN: 'Chain Link', ES: 'Malla ciclónica' }, height: '6 ft', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/cl-fence-black.jpg' },
];


const INSTALLERS = [
  { name: 'J2W Custom Fence', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/j2w-custom-fence.png' }, { name: 'True Fence', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/true-fence.png' }, { name: 'Good Hands Fencing', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/good-hands-fencing.png' }, { name: 'All American Fence & Gate', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/all-american-fence-and-gate.png' }, { name: 'SWFL Fence', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/swfl-fence.png' }, { name: 'Supreme Fence of SWFL', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/supreme-fence.png' }, { name: 'Southern Hoss Fences', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/southern-hoss-fences.png' }, { name: 'M.R. Fence', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/mr-fence.png' }, { name: 'Level Up Fencing', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/level-up-fencing.png' }, { name: 'Baker Fence & Gate', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/baker-fence-and-gate.png' }, { name: 'Grace Fence', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/grace-fence.png' }, { name: 'Fence Ace', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/fence-ace.png' }, { name: 'Zavala Fences', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/zavala-fences.png' }, { name: 'Fence Direct', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/fence-direct.png' }, { name: 'All American Fencing', src: 'https://crpozo.github.io/wfs-design-preview/assets/installers/all-american-fencing.png' },
];
...
const MARQUEE_PRODUCTS = [
  { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/chain-link-post.jpg', name: { EN: 'Chain Link Post', ES: 'Poste de malla' }, spec: { EN: 'Galvanized steel', ES: 'Acero galvanizado' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/gothic-post-cap.jpg', name: { EN: 'Gothic Post Cap', ES: 'Tapa de poste gótica' }, spec: { EN: 'White · PVC', ES: 'Blanca · PVC' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/chain-link-fabric.jpg', name: { EN: 'Chain Link Fabric', ES: 'Malla ciclónica' }, spec: { EN: '11-1/2 Ga. · Galvanized', ES: '11-1/2 Ga. · Galvanizada' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/self-closing-hinge.jpg', name: { EN: 'Self-Closing Hinge', ES: 'Bisagra con resorte' }, spec: { EN: 'Black · Spring-loaded', ES: 'Negra · Autocierre' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/pvc-double-gate.jpg', name: { EN: 'PVC Double Gate', ES: 'Portón doble de PVC' }, spec: { EN: 'White · Privacy', ES: 'Blanco · Privacidad' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/barbed-wire.jpg', name: { EN: 'Barbed Wire', ES: 'Alambre de púas' }, spec: { EN: 'Galvanized', ES: 'Galvanizado' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-2-rail.jpg', name: { EN: 'Aluminum 2-Rail', ES: 'Aluminio 2 rieles' }, spec: { EN: 'Black · Smooth bottom', ES: 'Negro · Base lisa' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/gravity-latch.jpg', name: { EN: 'Gravity Latch', ES: 'Pestillo de gravedad' }, spec: { EN: 'Black', ES: 'Negro' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/metal-privacy-white.jpg', name: { EN: 'Metal Privacy Panel', ES: 'Panel metálico privacidad' }, spec: { EN: 'White · Vertical', ES: 'Blanco · Vertical' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/drop-rod.jpg', name: { EN: 'Drop Rod', ES: 'Pasador vertical' }, spec: { EN: 'Black · Powder-coated', ES: 'Negro · Pintura en polvo' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/pvc-semi-privacy.jpg', name: { EN: 'Semi-Privacy PVC', ES: 'PVC semiprivacidad' }, spec: { EN: 'Tan · Horizontal', ES: 'Arena · Horizontal' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/gate-post-hinge.jpg', name: { EN: 'Gate Post Hinge', ES: 'Bisagra de poste' }, spec: { EN: 'Black · Heavy duty', ES: 'Negra · Uso rudo' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-3-rail.jpg', name: { EN: 'Aluminum 3-Rail', ES: 'Aluminio 3 rieles' }, spec: { EN: 'Black · Rake bottom', ES: 'Negro · Base inclinada' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/pvc-u-channel.jpg', name: { EN: 'PVC U-Channel', ES: 'Canal U de PVC' }, spec: { EN: 'White', ES: 'Blanco' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/chain-link-gate.jpg', name: { EN: 'Chain Link Gate', ES: 'Portón de malla' }, spec: { EN: 'Black · Single swing', ES: 'Negro · Una hoja' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/post-mount-latch.jpg', name: { EN: 'Post-Mount Latch', ES: 'Pestillo de poste' }, spec: { EN: 'Black · Self-locking', ES: 'Negro · Autobloqueante' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/metal-horizontal-black.jpg', name: { EN: 'Horizontal Metal Panel', ES: 'Panel metálico horizontal' }, spec: { EN: 'Black · Louvered', ES: 'Negro · Persiana' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/pvc-picket-panel.jpg', name: { EN: 'PVC Picket Panel', ES: 'Panel de estacas PVC' }, spec: { EN: 'White · Spaced picket', ES: 'Blanco · Estaca espaciada' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/metal-post.jpg', name: { EN: 'Metal Post', ES: 'Poste metálico' }, spec: { EN: 'Black · Square', ES: 'Negro · Cuadrado' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/privacy-windscreen.jpg', name: { EN: 'Privacy Windscreen', ES: 'Malla sombra' }, spec: { EN: 'Black · Grommeted', ES: 'Negra · Con ojales' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-puppy-picket.jpg', name: { EN: 'Puppy Picket Section', ES: 'Sección puppy picket' }, spec: { EN: 'Black · Aluminum', ES: 'Negra · Aluminio' } }, { src: 'https://crpozo.github.io/wfs-design-preview/assets/products/aluminum-section.jpg', name: { EN: 'Aluminum Section', ES: 'Sección de aluminio' }, spec: { EN: 'Black · Flat top', ES: 'Negra · Remate plano' } },
];
      ...
      <div className="container">
        ...
        <div style={{
          ...
          <div className="wfs-map" style={{
            ...
            <img loading="lazy" decoding="async" src="https://crpozo.github.io/wfs-design-preview/assets/us-map.svg" alt={t('Florida map showing WFS service area', 'Mapa de Florida que muestra la zona de servicio de WFS')}
              style={{
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError((err && err.message) || t(
        "We couldn't send your request. Please call us at (239) 465-2482 or email sales@westernfencesupply.com.", 'No pudimos enviar tu solicitud. Llámanos al (239) 465-2482 o escribe a sales@westernfencesupply.com.'
      ));
    } finally {
      busy.current = false;
      setSending(false);
          ...
          <div style={{ paddingTop: 8 }}>
            {[
              { name: 'Fort Myers', chip: t('Yard 1 · HQ', 'Sucursal 1 · Sede'),
                phone: '(239) 465-2482', tel: 'tel:2394652482',
              ...
              { name: 'Port Charlotte', chip: t('Yard 2', 'Sucursal 2'),
                phone: '(941) 467-5821', tel: 'tel:9414675821',
      ...
      <div className="container">
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.12)', paddingTop: 24, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 24 }}>
            {/* Solo enlaces con destino real: la politica de privacidad existe en
                el WordPress de produccion; "Terms" y "Accessibility" no tienen
                pagina, asi que no se enlazan (un href="#" es un boton en blanco). */}
            {[
              { label: { EN: 'Privacy', ES: 'Privacidad' }, href: 'https://westernfencesupply.com/privacy-policy/' },
              { label: 'sales@westernfencesupply.com', href: 'mailto:sales@westernfencesupply.com' }, ].map((item, i) => (
              <a key={i} href={item.href} style={{ fontSize: 14.5, fontFamily: 'var(--mono)', letterSpacing: '0.1em', color: 'var(--silver)' }}>
