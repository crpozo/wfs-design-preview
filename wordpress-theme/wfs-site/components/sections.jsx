      ...
      <div className="container">
        ...
        <div style={{
          ...
          <div className="wfs-map" style={{
            ...
            <img src="https://crpozo.github.io/wfs-design-preview/assets/us-map.svg" alt={t('Florida map showing WFS service area', 'Mapa de Florida que muestra la zona de servicio de WFS')}
              style={{
