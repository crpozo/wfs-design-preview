...
const FULL_PROJECTS = [
  ...
  { name: { EN: 'Naples Pool Enclosure', ES: 'Cerramiento de piscina Naples' },       loc: 'Naples, FL',         size: '180 LF',  material: 'Vinyl',      type: { EN: 'Vinyl privacy, 6 ft, pool-code compliant', ES: 'Privacidad de vinilo, 6 ft, cumple código de piscinas' }, contractor: 'Naples Outdoor',        year: '2025', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/pvc-closed-top-white.jpg' },
  ...
  { name: { EN: 'Fort Myers Industrial Park', ES: 'Parque Industrial Fort Myers' },  loc: 'Fort Myers, FL',     size: '1.4 mi',  material: 'Chain Link', type: { EN: 'Vinyl-coated black, 8 ft, with cantilever gates', ES: 'Recubierto de vinilo negro, 8 ft, con portones cantilever' },     contractor: 'Industrial Fence FL',   year: '2025', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/cl-gate-black.jpg' },
  { name: { EN: 'Lehigh Acres Subdivision', ES: 'Fraccionamiento Lehigh Acres' },    loc: 'Lehigh Acres, FL',   size: { EN: '52 lots', ES: '52 lotes' }, material: 'Vinyl',      type: { EN: 'Vinyl privacy white, 6 ft, walk + double gates', ES: 'Privacidad de vinilo blanco, 6 ft, portón peatonal + portones dobles' },   contractor: 'Lehigh Outdoor Co.',    year: '2024', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/pvc-privacy-gate-white.jpg' },
  { name: { EN: 'Marco Island Resort', ES: 'Resort Marco Island' },         loc: 'Marco Island, FL',   size: '780 LF',  material: 'Metal',      type: { EN: 'Metal fence, 3-rail, brown, HVHZ', ES: 'Cerca metálica, 3 rieles, marrón, HVHZ' },     contractor: 'Coastline Fence Co.',   year: '2025', imgUrl: 'https://crpozo.github.io/wfs-design-preview/assets/projects/met-fence-3-rail-brown.jpg' },
        ...
        <div className="wfs-projects-grid" style={{
          ...
          {visible.map((p, i) => (
            <ProjectCard key={p.name.EN} p={{
              ...
              type: t(p.type),
              size: t(p.size),
              material: t(MAT_LABELS[p.material]),
            }} i={i}
          ...
          <div>
            ...
            <div style={{ marginTop: 24 }}>
              <StatStrip dark items={[
                ['1.4 mi', t('Perimeter', 'Perímetro')],
                ['6', t('Gates', 'Portones')],
                ['8 ft', t('Mesh height', 'Altura de malla')],
                ['11 wk', t('Project span', 'Duración del proyecto')],
              ]}/>
            </div>
          </div>
        </div>
