...
const ProjectsHero = () => {
  ...
  return (
    <PageHero
      ...
      image="https://crpozo.github.io/wfs-design-preview/assets/MET.png"
    />
  );
};
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 56, alignItems: 'center' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 10, width: 'min(100%, 620px)', justifySelf: 'center', position: 'relative' }}>
            <div style={{ position: 'relative', aspectRatio: '4 / 5', overflow: 'hidden' }}>
              <img src="https://crpozo.github.io/wfs-design-preview/assets/projects/cl-swing-gate-galv-4.jpg"
                alt={t('Fort Myers Industrial Park perimeter', 'Perímetro del Fort Myers Industrial Park')}
                style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }}/>
            </div>
            <div style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: 10 }}>
              {['https://crpozo.github.io/wfs-design-preview/assets/projects/cl-fence-black-2.jpg', 'https://crpozo.github.io/wfs-design-preview/assets/projects/cl-gate-black.jpg'].map((src) => (
