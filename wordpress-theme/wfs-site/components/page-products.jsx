...
const ProductsHero = () => {
  ...
  <PageHero
    ...
    image="https://crpozo.github.io/wfs-design-preview/assets/PVC.webp"
    actions={[{
      primary: true, href: 'https://crpozo.github.io/wfs-design-preview/assets/wfs-catalog.pdf', download: 'WFS-Fence-Catalog.pdf', label: (
...
const PRODUCT_INTRO_STATS = [
  ['5', { EN: 'Fence systems', ES: 'Sistemas de cerca' }], ['5', { EN: 'Gate systems', ES: 'Sistemas de portón' }], ['2', { EN: 'Yards · FM + PC', ES: 'Sucursales · FM + PC' }], [{ EN: 'Lifetime', ES: 'De por vida' }, { EN: 'Warranty', ES: 'Garantía' }],
];
  ...
  <section style={{ background: 'var(--white)', padding: '120px 0' }}>
    <div className="container">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14 }}>
        {[
          [t('Posts & rails', 'Postes y rieles'), t('Posts for every material, in a range of colors, end, corner and line posts (EP/CP/LP) for aluminum and PVC, chain-link posts by diameter and gauge, and a single profile for metal.', 'Postes para cada material, en varios colores: postes de extremo, esquina y línea (EP/CP/LP) para aluminio y PVC, postes de chain link según diámetro y calibre, y un solo perfil para metal.')], [t('Hinges & latches', 'Bisagras y pestillos'), t('Stainless hinges, drop rods, magnetic latches, padlockable kits.', 'Bisagras de acero inoxidable, varillas de anclaje, pestillos magnéticos, kits con candado.')], [t('Caps & fittings', 'Tapas y accesorios'), t('Post caps, tension bands and brace bands, plus the chain-link fittings that finish a run.', 'Tapas de poste, bandas de tensión y de refuerzo, más los accesorios de chain link que rematan el tramo.')], [t('Gate automation', 'Automatización'), t("We don't build automated gates. The most we do is weld on a mounting plate so you can add your own operator, sourcing and setting up the automation is on you.", 'No fabricamos portones automáticos. Lo máximo que hacemos es soldar un plato de montaje para que instales tu propio operador; conseguir y configurar la automatización corre por tu cuenta.')], ].map(([title, body]) => (
          <article key={title} style={{
            background: 'var(--white)', padding: '24px 22px', border: '1px solid rgba(0,16,17,0.1)', }}>
            <div className="mono" style={{
              fontSize: 13.5, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--tangerine)', fontWeight: 700, marginBottom: 10, }}>{t('Hardware', 'Herrajes')}</div>
