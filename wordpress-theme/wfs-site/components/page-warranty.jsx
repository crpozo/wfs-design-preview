...
const ClaimsHero = () => {
  ...
  <PageHero
    ...
    image="https://crpozo.github.io/wfs-design-preview/assets/gate-cantilever.webp"
  />
  );
};
...
const SpecsHero = () => {
  ...
  <PageHero
    ...
    image="https://crpozo.github.io/wfs-design-preview/assets/ECFENCE.webp"
  />
  );
};
    ...
    <section style={{ background: 'var(--white)', padding: '120px 0' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 14 }}>
          {visible.map((d, i) => (
            <a key={d.file} href={'https://crpozo.github.io/wfs-design-preview/assets/specs/' + d.file} download target="_blank" rel="noopener"
              style={{
