...
const PoolCodeRequirements = () => {
  const t = useT();
  const reqs = [
    { code: t('Requirement 01', 'Requisito 01'), title: t('Minimum height', 'Altura mínima'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/01-min-height.png?v=238',           body: t('The barrier must be at least 48" high, measured on the side facing away from the pool. Additional requirements may apply depending on the project and installation.', 'La barrera debe tener al menos 48" de altura, medida en el lado opuesto a la piscina. Pueden aplicar requisitos adicionales según el proyecto y la instalación.') },
    { code: t('Requirement 02', 'Requisito 02'), title: t('Openings & picket spacing', 'Aberturas y separación entre pickets'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/02-openings.png?v=238',           body: t('Openings generally must not allow a 4" sphere to pass through. Additional spacing restrictions may apply depending on the barrier design.', 'En general, las aberturas no deben permitir el paso de una esfera de 4". Pueden aplicar restricciones de separación adicionales según el diseño de la barrera.') },
    { code: t('Requirement 03', 'Requisito 03'), title: t('Self-closing & self-latching gates', 'Portones con cierre y cerrojo automáticos'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/03-self-closing.png?v=238',     body: t('Pool access gates must be self-closing and self-latching. Gate hardware and latch placement must meet applicable requirements.', 'Los portones de acceso a la piscina deben tener cierre automático y cerrojo automático. Los herrajes del portón y la ubicación del pestillo deben cumplir los requisitos aplicables.') },
    { code: t('Requirement 04', 'Requisito 04'), title: t('Gate swing direction', 'Dirección de apertura del portón'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/04-swing.png?v=238',     body: t('Pedestrian access gates must open outward, away from the pool.', 'Los portones de acceso peatonal deben abrir hacia afuera, alejándose de la piscina.') },
    { code: t('Requirement 05', 'Requisito 05'), title: t('Latch release location', 'Ubicación de la liberación del pestillo'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/05-latch.png?v=238',   body: t('Latch placement depends on the gate configuration and must meet applicable requirements.', 'La ubicación del pestillo depende de la configuración del portón y debe cumplir los requisitos aplicables.') },
  ...
  },
  {
    ...
    items: [
      ...
      [{ EN: 'What colors can I get?', ES: '¿Qué colores puedo conseguir?' },
       { EN: 'Chain link comes in black, green, and galvanized. Metal / DuraFence in bronze, white, black, and woodgrain. Vinyl / PVC in white, sand, and gray. Aluminum in bronze, white, and black.', ES: 'La malla ciclónica viene en negro, verde y galvanizado. El Metal / DuraFence en bronce, blanco, negro e imitación madera (woodgrain). El vinilo / PVC en blanco, arena (sand) y gris. El aluminio en bronce, blanco y negro.' }],
    ],
  },
  {
    id: 'pickup',
    ...
    items: [
      [{ EN: 'Where do I pick up my order?', ES: '¿Dónde recojo mi pedido?' },
       { EN: "Whichever yard is more convenient for you — Fort Myers (2621 Fowler St) or Port Charlotte (1145 Enterprise Dr). About 90% of the time both yards carry the same stock, so it's your call. Contact us first and we'll confirm before you head out.", ES: 'En la sucursal que te quede más cómoda: Fort Myers (2621 Fowler St) o Port Charlotte (1145 Enterprise Dr). El 90% del tiempo ambas sucursales tienen el mismo stock, así que tú decides. Contáctanos primero y te confirmamos antes de que salgas.' }],
