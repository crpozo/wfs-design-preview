...
const PoolCodeRequirements = () => {
  const t = useT();
  const reqs = [
    { code: t('Requirement 01', 'Requisito 01'), title: t('Minimum height', 'Altura mínima'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/01-min-height.webp?v=238', body: t('The barrier must be at least 48" high, measured on the side facing away from the pool. Additional requirements may apply depending on the project and installation.', 'La barrera debe tener al menos 48" de altura, medida en el lado opuesto a la piscina. Pueden aplicar requisitos adicionales según el proyecto y la instalación.') }, { code: t('Requirement 02', 'Requisito 02'), title: t('Openings & picket spacing', 'Aberturas y separación entre pickets'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/02-openings.webp?v=238', body: t('Openings generally must not allow a 4" sphere to pass through. Additional spacing restrictions may apply depending on the barrier design.', 'En general, las aberturas no deben permitir el paso de una esfera de 4". Pueden aplicar restricciones de separación adicionales según el diseño de la barrera.') }, { code: t('Requirement 03', 'Requisito 03'), title: t('Self-closing & self-latching gates', 'Portones con cierre y cerrojo automáticos'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/03-self-closing.webp?v=238', body: t('Pool access gates must be self-closing and self-latching. Gate hardware and latch placement must meet applicable requirements.', 'Los portones de acceso a la piscina deben tener cierre automático y cerrojo automático. Los herrajes del portón y la ubicación del pestillo deben cumplir los requisitos aplicables.') }, { code: t('Requirement 04', 'Requisito 04'), title: t('Gate swing direction', 'Dirección de apertura del portón'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/04-swing.webp?v=238', body: t('Pedestrian access gates must open outward, away from the pool.', 'Los portones de acceso peatonal deben abrir hacia afuera, alejándose de la piscina.') }, { code: t('Requirement 05', 'Requisito 05'), title: t('Latch release location', 'Ubicación de la liberación del pestillo'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/05-latch.webp?v=238', body: t('Latch placement depends on the gate configuration and must meet applicable requirements.', 'La ubicación del pestillo depende de la configuración del portón y debe cumplir los requisitos aplicables.') }, { code: t('Requirement 06', 'Requisito 06'), title: t('Dwelling wall as part of the barrier', 'Muro de la vivienda como parte de la barrera'), img: 'https://crpozo.github.io/wfs-design-preview/assets/poolcode/06-dwelling.webp?v=238', body: t('Doors and windows providing direct access to the pool area may require approved safety features under applicable local requirements.', 'Las puertas y ventanas con acceso directo al área de la piscina pueden requerir dispositivos de seguridad aprobados según los requisitos locales aplicables.') }, ];
