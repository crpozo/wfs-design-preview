...
const FAQ_TOPICS = [
  ...
  },
  {
    ...
    items: [
      ...
      [{ EN: "Can my order be ready when I arrive?", ES: "\xBFPuede estar listo mi pedido cuando llegue?" }, { EN: "Yes, call ahead and standard qualifying orders are pulled and staged the same day, waiting at the bay. Hours: Mon-Fri 7am-4pm, Sat 7am-12pm.", ES: "S\xED: avisa con anticipaci\xF3n y los pedidos est\xE1ndar que califiquen se preparan el mismo d\xEDa y te esperan en la bah\xEDa. Horario: lun-vie 7am-4pm, s\xE1b 7am-12pm." }],
