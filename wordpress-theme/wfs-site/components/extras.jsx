...
const Testimonials = () => {
  ...
  const MAT_IMG = {
    vinyl: 'https://crpozo.github.io/wfs-design-preview/assets/compare/vinyl.png?v=250', aluminum: 'https://crpozo.github.io/wfs-design-preview/assets/compare/aluminum.png?v=250', chainlink: 'https://crpozo.github.io/wfs-design-preview/assets/compare/chainlink.webp?v=250', metal: 'https://crpozo.github.io/wfs-design-preview/assets/compare/metal.png?v=250', };
    ...
    <section style={{ background: 'var(--white)', padding: '120px 0' }}>
      <div className="container" style={{
        ...
        <div style={{
          ...
          <video
            ref={videoRef}
            src="https://crpozo.github.io/wfs-design-preview/assets/first-video.mp4?v=247"
