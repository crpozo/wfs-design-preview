...
const Testimonials = () => {
  const t = useT();
  const reviews = [
    { name: 'Lauren Johnson', mat: 'aluminum',
    ...
    { name: 'Sally Barney', mat: 'chainlink',
    ...
    { name: 'Reinier Carmenates', mat: 'metal',
    ...
    { name: 'Marcus Reed', mat: 'chainlink',
    ...
    { name: 'Dana Whitfield', mat: 'aluminum',
  ...
  const MAT_IMG = {
    vinyl: 'https://crpozo.github.io/wfs-design-preview/assets/compare/vinyl.png?v=250',
    aluminum: 'https://crpozo.github.io/wfs-design-preview/assets/compare/aluminum.png?v=250',
    chainlink: 'https://crpozo.github.io/wfs-design-preview/assets/compare/chainlink.webp?v=250',
    metal: 'https://crpozo.github.io/wfs-design-preview/assets/compare/metal.png?v=250',
  };
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    boxShadow: 'inset 0 0 0 1px rgba(0,16,17,0.1)',
