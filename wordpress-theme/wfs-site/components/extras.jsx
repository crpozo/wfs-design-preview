...
const Gates = () => {
  const t = useT();
  const gates = [
    { name: { EN: 'Single Walk Gates', ES: 'Portones peatonales sencillos' }, desc: { EN: 'Mechanically assembled or welded. Standard widths 3-4 ft.', ES: 'Fabricado a medida. Anchos estándar de 3-4 ft.' }, img: 'aluminum' }, { name: { EN: 'Double Drive Gates', ES: 'Portones dobles vehiculares' }, desc: { EN: 'Welded heavy-duty up to 16 ft total. Stainless steel hardware.', ES: 'De alta resistencia, hasta 16 ft en total. Herrajes de acero inoxidable.' }, img: 'metal' }, { name: { EN: 'Custom Estate Gates', ES: 'Portones a medida de alta gama' }, desc: { EN: 'Welded estate-grade aluminum, fully fabricated in-house.', ES: 'Aluminio de alta gama, fabricado por completo en planta.' }, img: 'vinyl' }, { name: { EN: 'Chain Link Gates', ES: 'Portones de malla ciclónica' }, desc: { EN: 'Welded chain link gates plus full hardware kit.', ES: 'Portones de malla ciclónica con kit completo de herrajes.' }, img: 'chainlink' }, ];
  return (
...
const Testimonials = () => {
  ...
  const MAT_IMG = {
    vinyl: 'https://crpozo.github.io/wfs-design-preview/assets/compare/vinyl.webp?v=250', aluminum: 'https://crpozo.github.io/wfs-design-preview/assets/compare/aluminum.webp?v=250', chainlink: 'https://crpozo.github.io/wfs-design-preview/assets/compare/chainlink.webp?v=250', metal: 'https://crpozo.github.io/wfs-design-preview/assets/compare/metal.webp?v=250', };
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div className="mono" style={{
                      marginTop: 3, fontSize: 13, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'var(--charcoal)', }}>{t(r.tag)}</div>
                  </div>
                </div>
              </div>
            </div>
...
const FAQ = () => {
  const t = useT();
  const items = [
    [{ EN: 'Do you sell to the general public?', ES: '¿Le venden al público en general?' }, { EN: 'Yes. We sell to homeowners, DIY customers and contractors alike, same supplier-direct prices, no minimums.', ES: 'Sí. Vendemos a propietarios, clientes DIY y contratistas por igual, los mismos precios directos del proveedor, sin mínimos.' }], [{ EN: 'What are the lead times on fencing material?', ES: '¿Cuáles son los plazos de entrega del material?' }, { EN: "Anything in stock is ready right away, buy it and take it the same day. A lot of suppliers make you wait 1-2 days even for stocked material; we don't. Custom or non-stock orders run anywhere from 1-2 days to 6-8 weeks depending on the item.", ES: 'Lo que está en stock está listo de inmediato, lo compras y te lo llevas el mismo día. Muchos proveedores te hacen esperar 1-2 días incluso para material en stock; nosotros no. Las órdenes a medida o fuera de stock van de 1-2 días hasta 6-8 semanas según el artículo.' }], [{ EN: 'Do you install fences?', ES: '¿Instalan cercas?' }, { EN: 'No, we are solely a supply company. We can recommend trusted local installers who use our materials.', ES: 'No, somos solamente una empresa de suministro. Podemos recomendar instaladores locales de confianza que usan nuestros materiales.' }], [{ EN: 'What is the price per foot for fence material?', ES: '¿Cuál es el precio por pie del material?' }, { EN: "Pricing fluctuates frequently. Send us your project and we'll come back with a detailed estimate.", ES: 'Los precios fluctúan con frecuencia. Envíanos tu proyecto y respondemos con un estimado detallado.' }], [{ EN: 'Does your fence material have a warranty?', ES: '¿El material tiene garantía?' }, { EN: 'Most materials we sell carry a limited lifetime warranty from the manufacturer.', ES: 'La mayoría de los materiales que vendemos tienen una garantía limitada de por vida del fabricante.' }], [{ EN: 'Do you offer delivery?', ES: '¿Ofrecen entrega?' }, { EN: "Yes, we deliver throughout Florida from our Fort Myers warehouse. Delivery fees vary by location and order size; we'll confirm both when you place your order.", ES: 'Sí, entregamos en toda Florida desde nuestro almacén de Fort Myers. Los costos varían por ubicación y tamaño de la orden; confirmamos ambos al hacer el pedido.' }], [{ EN: 'Can I pick up my order?', ES: '¿Puedo recoger mi pedido?' }, { EN: 'Yes. Pickup is available from our Fort Myers or Port Charlotte yards depending on material stock. Please contact us first to confirm availability and pickup location before coming in.', ES: 'Sí. Puedes recoger en nuestras sucursales de Fort Myers o Port Charlotte según el stock del material. Contáctanos primero para confirmar disponibilidad y ubicación antes de venir.' }], ];
    ...
    <section style={{ background: 'var(--parchment)', padding: '120px 0', borderTop: '1px solid rgba(0,16,17,0.08)' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
          {posts.map((p, i) => (
            <article key={i} style={{
              background: 'var(--white)', borderRadius: 'var(--radius-lg)', overflow: 'hidden', cursor: 'pointer', transition: 'transform 0.2s', }}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 60, alignItems: 'center' }}>
        <div>
          ...
          <p style={{ fontSize: 18.5, lineHeight: 1.55, color: 'var(--alice-blue)', maxWidth: 460, marginBottom: 24 }}>
            {t(
              'Western Fence Supply is led by management with two decades of fence installation and fabrication experience. We refuse to sell low-quality components, same standard we held when we were the contractors.', 'Western Fence Supply está dirigida por un equipo con dos décadas de experiencia en instalación y fabricación de cercas. Nos negamos a vender componentes de baja calidad, el mismo estándar que manteníamos cuando éramos los contratistas.'
            )}
          </p>
          <p style={{ fontSize: 16.5, lineHeight: 1.55, color: 'var(--silver)', maxWidth: 460, marginBottom: 32 }}>
            {t(
              'From our Fort Myers fabrication shop, we transform raw fencing components into the highest-quality fence panels available on the market today.', 'Desde nuestra planta de fabricación en Fort Myers, transformamos componentes de cerca en bruto en los paneles de cerca de la más alta calidad disponibles hoy en el mercado.'
            )}
          </p>
  ...
  return (
    <section style={{ background: 'var(--white)', padding: '120px 0' }}>
      <div className="container" style={{
        display: 'grid', gridTemplateColumns: '1.08fr 1fr', gap: 56, alignItems: 'center', }}>
        ...
        <div style={{
          ...
          <video
            ref={videoRef}
            data-src="https://crpozo.github.io/wfs-design-preview/assets/first-video.mp4?v=279"
            poster="https://crpozo.github.io/wfs-design-preview/assets/first-video-poster.jpg?v=247"
            muted
            loop
            playsInline
            preload="none"
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i}>
                ...
                <div className="mono" style={{
                  marginTop: 6, fontSize: 13.5, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--charcoal)', }}>{t(l)}</div>
              </div>
            ))}
          </div>
