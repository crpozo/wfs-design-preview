...
.sede__btn {
  ...
  font-family: var(--display); font-size: 14.5px; font-weight: 400; color: var(--ink);
...
.opcion__nombre { flex: 1; min-width: 0; font-family: var(--display); font-weight: 400; font-size: 19px; letter-spacing: .01em; }
