...
.opcion__nombre { flex: 1; min-width: 0; }
...
var LOGOS = {
  zelle:   '<svg viewBox="0 0 44 44" aria-hidden="true"><rect width="44" height="44" fill="#6d1ed4"/>' +
           '<text x="22" y="31" text-anchor="middle" font-family="Archivo,Arial,sans-serif" font-weight="900" font-size="26" fill="#fff">Z</text></svg>',
  cashapp: '<svg viewBox="0 0 44 44" aria-hidden="true"><rect width="44" height="44" fill="#00d632"/>' +
           '<text x="22" y="31" text-anchor="middle" font-family="Archivo,Arial,sans-serif" font-weight="900" font-size="26" fill="#fff">$</text></svg>',
  paypal:  '<svg viewBox="0 0 44 44" aria-hidden="true"><rect width="44" height="44" fill="#fff"/>' +
           '<text x="16" y="32" text-anchor="middle" font-family="Archivo,Arial,sans-serif" font-weight="900" font-style="italic" font-size="26" fill="#003087">P</text>' +
           '<text x="24" y="34" text-anchor="middle" font-family="Archivo,Arial,sans-serif" font-weight="900" font-style="italic" font-size="26" fill="#009cde">P</text></svg>',
