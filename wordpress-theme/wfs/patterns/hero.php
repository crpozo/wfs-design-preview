<?php
/**
 * Title: Hero — titular con foto de fondo
 * Slug: wfs/hero
 * Categories: wfs
...
<h1 class="wp-block-heading has-huge-font-size">The best place to buy fence in Southwest Florida</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
<p style="font-size:18px">We're a one stop fence supply shop selling superior fences and gates at wholesale prices.</p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/homeowners">I'm a Homeowner</a></div>
<!-- /wp:button -->
<!-- wp:button {"backgroundColor":"white","textColor":"ink"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-ink-color has-white-background-color has-text-color has-background wp-element-button" href="/contractors">I'm a Contractor</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
